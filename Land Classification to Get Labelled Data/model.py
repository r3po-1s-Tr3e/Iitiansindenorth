...
torch.manual_seed(42)  # or any other number
print("init..")
...
NUM_CLASSES = 10
train_dir = r"C:\Users\hryad\Desktop\iitm\Space Apps\Land-Cover-Classification-using-Sentinel-2-Dataset\data\2750"
...
def get_model(load_weights=True):
    ...
    model = LULC_Model(pretrained=False)  # Initialize without pretrained weights
    if load_weights:
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), r"C:\Users\hryad\Desktop\iitm\Space Apps\Land-Cover-Classification-using-Sentinel-2-Dataset\Test 2.0model")
